...
def prepare_prompts(user_prompt: str) -> dict:
    ...
    # --- Adicionado tratamento de erro para JSON ---
    try:
        # Tenta limpar o raw de possíveis textos antes/depois do JSON
        json_start = raw.find('{')
        ...
        # Tenta um fallback se o modelo falhar em formatar como JSON
